    ...
    for file in files:
        ...
        if str(file).endswith('zip'):
            ...
            for sub_file in sub_files:                
                ...
                sub_sub_files = os.listdir(out_put_file)
                for sub_sub_file in sub_sub_files:
                    if str(sub_sub_file).startswith('Multimode_UniPay_payinfo'):
                        unzip_file(out_put_file + "/" +sub_sub_file, out_put_file)
                        os.remove(os.path.join(out_put_file, sub_sub_file))  
                    else:
                        #pass
                        os.remove(os.path.join(out_put_file, sub_sub_file)) 
